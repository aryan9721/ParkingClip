...
const CreateBusiness = () => {
  ...
  const submitUser = async (e) => {
    ...
    const userdata = {
      ...
      middleName: middleName ? middleName : "Not Defined",
      lastName: lastName ? lastName : "Not Defined",
      businessContactNo: businessContactNo,
      personalContactNo: personalContactNo ? personalContactNo :"Not Defined",
      businessAddress: businessAddress,
      personalAddress: personalAddress ?  personalAddress : "Not Defined",
      businessPincode: businessPincode,
      personalPincode: personalPincode ? personalPincode : "Not Defined",
      businessEmailId: businessEmailId,
      personalEmailId: personalEmailId ? personalEmailId : "Not Defined",
      gstNo: gstNo,
      pancardNo: pancardNo,
    };
      ...
      <div className="homeContainer">
        <div className="body">
          <div className="formContainer">
            <h3>Create New Parking Business</h3>
            ...
            <div onChange={(e) => handlebusinessName(e)}style={{ width: "100%" }} className="formInput">
              ...
              <div onChange={(e) => handlemiddleName(e)}style={{ width: "30%" }} className="formInput">
                ...
                <input type={Text} placeholder={"Mahendra"} />
              </div>
              <div onChange={(e) => handlelastName(e)} style={{ width: "30%" }} className="formInput">
                <label>Last Name</label>
                <input type={Text} placeholder={"Vora"} />
              </div>

              </div>
              <div style={{ width: "100%" }} onChange={(e) => handlebusinessContactNo(e)} className="formInput">
              ...
              <div onChange={(e) => handlebusinessEmailId(e)} style={{ width: "100%" }} className="formInput">
                <label>Business EmailId*</label>
                <input required type="email" placeholder={"example@gmail.com"} />
              </div>
              <div onChange={(e) => handlegstNo(e)} style={{ width: "100%" }} className="formInput">
              ...
              <div style={{ width: "100%" }}  onChange={(e) => handlepersonalContactNo(e)} className="formInput">
